...
export type FindChannelByUsernameQuery = { __typename?: 'Query', findByUsername: { __typename?: 'UserModel', id: string, username: string, stream: { __typename?: 'StreamModel', title: string, thumbnailUrl?: string | null } } };
